package com.zhangkem.coopcycle.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.zhangkem.coopcycle.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.zhangkem.coopcycle.repository.UserRepository.USERS_BY_EMAIL_CACHE);
