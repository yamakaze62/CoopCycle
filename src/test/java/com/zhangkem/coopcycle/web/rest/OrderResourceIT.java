...
import static com.zhangkem.coopcycle.web.rest.TestUtil.sameInstant;
...
import com.zhangkem.coopcycle.repository.OrderRepository;
import com.zhangkem.coopcycle.service.dto.OrderDTO;
import com.zhangkem.coopcycle.service.mapper.OrderMapper;
...
class OrderResourceIT {
    ...
    private static final State DEFAULT_STATE = State.WAITINGRESTAURANTCONFIRM;
    private static final State UPDATED_STATE = State.PREPARING;

    private static final Float DEFAULT_TOTALPRICE = 5F;
    private static final Float UPDATED_TOTALPRICE = 6F;
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getIdRestaurant()).isEqualTo(DEFAULT_ID_RESTAURANT);
    ...
    @Test
    @Transactional
    void checkIdRestaurantIsRequired() throws Exception {
        int databaseSizeBeforeTest = orderRepository.findAll().size();
        // set the field null
        order.setIdRestaurant(null);
    ...
    void putNewOrder() throws Exception {
        ...
        assertThat(testOrder.getIdRestaurant()).isEqualTo(UPDATED_ID_RESTAURANT);
