...
class CooperativeResourceIT {
    ...
    public static Cooperative createEntity(EntityManager em) {
        Cooperative cooperative = new Cooperative().idCooperative(DEFAULT_ID_COOPERATIVE).name(DEFAULT_NAME);
        return cooperative;
    }
    ...
    public static Cooperative createUpdatedEntity(EntityManager em) {
        Cooperative cooperative = new Cooperative().idCooperative(UPDATED_ID_COOPERATIVE).name(UPDATED_NAME);
        return cooperative;
    }
    ...
    void putNewCooperative() throws Exception {
        ...
        updatedCooperative.idCooperative(UPDATED_ID_COOPERATIVE).name(UPDATED_NAME);
    ...
    void fullUpdateCooperativeWithPatch() throws Exception {
        ...
        partialUpdatedCooperative.idCooperative(UPDATED_ID_COOPERATIVE).name(UPDATED_NAME);
